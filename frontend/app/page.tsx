...
export default function Home() {
  ...
  const lastRetrievedDocsRef = useRef<SourceDocument[]>([]); // useRef to store the last retrieved documents
          ...
          if (event === 'messages/partial') {
            ...
            if (
              ...
              const retrievedDocs = (data as RetrieveDocumentsNodeUpdates)
                .retrieveDocuments.documents as SourceDocument[];
          ...
          <form onSubmit={handleSubmit} className="relative">
            <div className="flex gap-2 border rounded-md overflow-hidden bg-gray-50">
              ...
              <Input
                ...
                placeholder={
                  isUploading ? 'Uploading files...' : 'Send a message...'
                }
